...
public class FormActionServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		EmployeeViewBean employeeViewBean = (EmployeeViewBean) request.getSession().getAttribute("employeeViewBean");
		...
		if (request.getParameter("btnAddEmployee") != null) {
			...
			EmployeeDecorator employee = dao.search(request.getParameter("id"));
			if (employee != null) {
